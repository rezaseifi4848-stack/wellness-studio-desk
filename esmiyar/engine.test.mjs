...
test('runs deterministic rule details',()=>{const r=runRule(defaultRules[0],{name:'علی',mother:'مریم'});assert.equal(r.total,400);assert.equal(r.remainder,1);assert.equal(r.label,'نزولی')});
